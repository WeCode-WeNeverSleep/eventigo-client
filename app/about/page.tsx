      ...
      <main className="flex-1 w-full xl:px-[150px] lg:px-[150px] px-4 sm:px-6 py-12 md:py-20">
        <div className="mb-16 md:mb-24 max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-text-muted leading-relaxed max-w-2xl">
            EventiGO is the premier platform designed specifically for the tech
            community. We curate, host, and manage world-class conferences,
            technical workshops, and developer meetups globally.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                Handpicked conferences and exclusive workshops without the
                fluff. We focus on high-signal content for engineers and
                designers.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                High-definition, low-latency streams for global access. Never
                miss a keynote, whether you are in Paris, Tokyo, or San
                Francisco.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                Interact with speakers in real-time. Our integrated Q&A system
                bridges the gap between the stage and the audience.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                Dedicated spaces for community building. Find co-founders, hire
                top talent, or just talk tech over a virtual coffee.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                From local meetups to international summits, our infrastructure
                scales globally to deliver seamless experiences anywhere.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface/30 hover:bg-surface transition-colors">
              ...
              <p className="text-text-muted leading-relaxed">
                Frictionless registration and fast, secure access control. We
                handle the logistics so you can focus on the learning.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-12 md:p-16 rounded-4xl border border-border bg-surface relative overflow-hidden flex flex-col items-center text-center">
          ...
          <p className="text-text-muted mb-8 max-w-xl z-10">
            Explore our curated calendar and secure your spot before tickets run
            out.
          </p>
          <Link
            href="/events"
