...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 xl:mx-[250px] lg:mx-[150px] mx-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <div className="flex items-center gap-2 text-xs font-bold tracking-widest text-text-muted uppercase mb-3">
                <FontAwesomeIcon icon={faCalendarDays} className="text-primary w-3 h-3" />
                ON THE CALENDAR
              </div>
              <h2 className="text-4xl md:text-5xl font-bold font-title text-text-main">Upcoming events</h2>
              <p className="text-text-muted mt-2">Six events across the next six months — handpicked, no fluff.</p>
            </div>
            <Link href="/events" className="text-sm text-text-muted hover:text-text-main transition-colors flex items-center gap-1">
