...
export function SpeakerCard({ speaker }: SpeakerCardProps) {
    return (
        <div className="border border-border rounded-4xl p-6 bg-background hover:bg-surface transition-colors h-full flex flex-col w-full max-w-sm px-4 cursor-pointer hover:border-primary/30 group">
            {/* Avatar Section */}
